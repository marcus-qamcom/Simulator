...
for i=1:dim_size
        ...
        [T_tmp D_tmp RSSI_tmp LAT_tmp LONG_tmp SEQ_tmp lab] = ...
          getLink(TEST_SPEC, char(PLATOON_ANT(i)), char(PLATOON_ANT(i)) );

        % Filter data
        [T_tmp D_tmp RSSI_tmp LAT_tmp LONG_tmp SEQ_tmp] = ...
          filterTimeSlices(TIME_SLICES, T_tmp, D_tmp, RSSI_tmp, LAT_tmp, LONG_tmp, SEQ_tmp);
...
save(file_data,'RX_T_ALL', 'RX_D_ALL', 'RX_RSSI_ALL', 'RX_LAT_ALL', 'RX_LONG_ALL', 'RX_SEQ_ALL', ...
                               'TX_T_ALL', 'TX_D_ALL', 'TX_RSSI_ALL', 'TX_LAT_ALL', 'TX_LONG_ALL', 'TX_SEQ_ALL');
